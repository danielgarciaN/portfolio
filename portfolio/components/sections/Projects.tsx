      ...
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-surface-200 bg-white py-2 pl-9 pr-4 text-sm text-surface-700 placeholder:text-surface-400 focus:border-accent/50 focus:outline-none focus:ring-2 focus:ring-accent/20 dark:border-surface-700 dark:bg-surface-900 dark:text-surface-200 dark:placeholder:text-surface-500 sm:w-64"
          />
        </div>
      </div>
